    ...
    <div style={{
      ...
      <div>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '15px' }}>
            ...
            {state.total > 0 && (
              <>
                <div style={{
                  ...
                  <span>Progress:</span>
                  <span>{state.progress.toLocaleString()} / {state.total.toLocaleString()}</span>
                </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ color: '#6b7280', fontSize: '11px' }}>New</div>
              ...
              <div>
                <div style={{ color: '#6b7280', fontSize: '11px' }}>Errors</div>
        ...
        <div style={{ display: 'flex', gap: '10px', marginBottom: '15px' }}>
          ...
          >
            {state.status === 'running' ? 'Running...' : 'Start'}
          </button>
          <button
            onClick={handleStop}
            disabled={state.status !== 'running'}
        ...
        {state.search_query && (
          <div style={{
            ...
            <div style={{ color: '#d1d5db', fontFamily: 'monospace', fontSize: '10px', wordBreak: 'break-all' }}>
              {state.search_query}
            </div>
          </div>
        )}
